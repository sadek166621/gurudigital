        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 p-5 p-md-0 p-lg-5">
                <div class="col-md-8 mt-3 mt-md-4 pt-3 pt-md-4">
                    <h3 class="text-color fw-medium">Log in </h3>
                </div>

                <form action="{{ route('become-instractor-login') }}" method="Post">
                    @csrf
                    <div class="col-md-8 mt-3 mt-md-4">
                        <label for="inputEmail" class="form-label text-color fw-medium"> Email </label>
