                ...
                <article>
                    <div class="entry">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href=""><button type="button" class="btn btn-warning">Be a Financial Contributor</button>
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('contact') }}"><button type="button" class="btn btn-warning">Share this Nobel Effot</button>
                                </a>
                            </div>
                        </div>
                    </div>
