...
(function (global, factory) {
  ...
  var defaultInputValidators = {
    ...
    url: function url(string%2c%20validationMessage.html) {
  ...
  function update(params) {
    ...
    Object.keys(params).forEach(function (param) {
      if (Swal.isUpdatableParameter(param)) {
        ...
        warn("Invalid parameter to update: \"".concat(param, "\".%20Updatable%20params%20are%20listed%20here_%20https_/github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.html"));
      }
    });
